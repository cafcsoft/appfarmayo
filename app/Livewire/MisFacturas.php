...
class MisFacturas extends Component
{
    ...
    {
        $this->fecha_ini = Carbon::today()->subMonths(3)->format('Y-m-d');
    ...
    private function buildQuery()
    {
        ...
        $query3 = DB::table('notacred_cab')
            ...
            ->select(
                ...
                DB::raw("'Comprobante Nota Credito' AS nombclie"),
    ...
    public function render()
    {
        ...
        return view('livewire.mis-facturas', [
            'facturas' => $facturas,
